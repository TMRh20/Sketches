/*
 * *************************************************************************
 * RF24Ethernet Arduino library by TMRh20 - 2014-2025
 *
 * Automated (mesh) wireless networking and TCP/IP communication stack for RF24 radio modules
 *
 * RF24 -> RF24Network -> uIP or lwIP(TCP/IP) -> RF24Ethernet
 *                     -> RF24Mesh
 *
 ...
 * *************************************************************************
 *
 * This example demonstrates how to configure a Headless client connecting to an HTTP server
...
void connect() {
  ...
  if (client.connect(host, 80)) {
    ...
    // Reset the client connection timeout timer
